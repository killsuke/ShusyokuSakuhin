...
void ArbitraryRotationComponent::DefaultRollingMove() {
	...
	const XMVECTOR newVec = XMVectorAdd(centerPosVec, rotatedOffset);
	...
	const XMVECTOR localQuat = DirectX::XMQuaternionRotationRollPitchYaw(
		pitch,
		yaw,
		roll
	);
