...
RenderRingLuminescenceBillboardComponent::RenderRingLuminescenceBillboardComponent(GameObject& obj) : RenderComponent(obj) {
	m_SortNum = ComponentTypeManager::GetID_FromName("RENDER_DELAY"); // ソート番号を設定
	m_Shader = std::make_unique<Shader>();
}

void RenderRingLuminescenceBillboardComponent::Update()
{
