...
void EnemyJsonComponent::MakeSampleStatus() {
    ...
    { "E_NoMove" , {5.0f,5.0f,5.0f}, { 0.0f,0.0f,0.0f },"assets/texture/NoTexture.png","shader/unlitTextureVS.hlsl", "shader/unlitTexturePS.hlsl"},
    { "E_dice" ,  {5.0f,10.0f,5.0f}, { 0.0f,0.0f,0.0f },"assets/texture/dice.png","shader/unlitTextureVS.hlsl", "shader/unlitTexturePS.hlsl"},
    };
