...
//	Enemeis();
	...
	transPlayer->SetScale(Vector3(6.0f,10.0f,5.0f));
	...
	renderPlayer->SetShader("shader/Animation2DVS.hlsl", "shader/unlitTexturePS.hlsl");
	...
	colliderPlayer->SetColliderSize_AABB(Vector3(0.0f, 0.0f, 0.0f),Vector3(6.0f, 10.0f, 5.0f));
...
void HighwayScene::Enemeis() {
	...
	enemy1Trans->SetPosition(Vector3(-100.0f, 0.0f, 100.0f));
	enemy1Trans->SetScale(Vector3(6.0f, 10.0f, 5.0f));
	...
	enemy1Render->SetShader("shader/Animation2DVS.hlsl", "shader/unlitTexturePS.hlsl");
	enemy1Render->SetColor(Vector4(1.0f, 1.0f, 1.0f, 1.0f));
...
//	LeapToCenterCarComponent* enemy1Leap = enemy1->AddComponent<LeapToCenterCarComponent>();
	...
	enemy2Trans->SetPosition(Vector3(-100.0f, 0.0f, 100.0f));
	enemy2Trans->SetScale(Vector3(6.0f, 10.0f, 5.0f));
	...
	enemy2Render->SetShader("shader/Animation2DVS.hlsl", "shader/unlitTexturePS.hlsl");
	enemy2Render->SetColor(Vector4(1.0f, 1.0f, 1.0f, 1.0f));
...
void HighwayScene::TerrainsCenter() {
	...
	terrain1Trans->SetPosition(Vector3(0.0f, -25.0f, 0.0f));
	terrain1Trans->SetScale(Vector3(50.0f, 30.0f, 50.0f));
	...
	terrain1Rend->SetShader("shader/litTextureVS.hlsl", "shader/litTexturePS.hlsl");
	auto rigid1 = terrain1->AddComponent<RigidBodyComponent>();
	//	rigid1->SetLimitVelocity(Vector3(50.0f, 100.0f, 100.0f));
	...
	terrain2Trans->SetPosition(Vector3(150.0f, -25.0f, 0.0f));
	terrain2Trans->SetScale(Vector3(50.0f, 30.0f, 50.0f));
	...
	terrain2Rend->SetShader("shader/litTextureVS.hlsl", "shader/litTexturePS.hlsl");
	...
	terrain3Trans->SetPosition(Vector3(300.0f, -35.0f, 0.0f));
	terrain3Trans->SetScale(Vector3(50.0f, 20.0f, 50.0f));
	...
	terrain3Rend->SetShader("shader/litTextureVS.hlsl", "shader/litTexturePS.hlsl");
	...
	terrain4Trans->SetPosition(Vector3(450.0f, -35.0f, 0.0f));
	terrain4Trans->SetScale(Vector3(50.0f, 20.0f, 50.0f));
	...
	terrain4Rend->SetShader("shader/litTextureVS.hlsl", "shader/litTexturePS.hlsl");
...

	{
		...
		terrain5Trans->SetPosition(Vector3(650.0f, -35.0f, 0.0f));
		terrain5Trans->SetScale(Vector3(100.0f, 20.0f, 50.0f));
		...
		terrain5Rend->SetShader("shader/litTextureVS.hlsl", "shader/litTexturePS.hlsl");
		...
		terrain6Trans->SetPosition(Vector3(750.0f, -10.0f, 0.0f));
		terrain6Trans->SetScale(Vector3(25.0f, 50.0f, 50.0f));
		...
		terrain6Rend->SetShader("shader/litTextureVS.hlsl", "shader/litTexturePS.hlsl");
	...
	terrain7Trans->SetPosition(Vector3(950.0f, -10.0f, 0.0f));
	terrain7Trans->SetScale(Vector3(100.0f, 50.0f, 50.0f));
	...
	terrain7Rend->SetShader("shader/litTextureVS.hlsl", "shader/litTexturePS.hlsl");
	...
	terrain8Trans->SetPosition(Vector3(1250.0f, -10.0f, 0.0f));
	terrain8Trans->SetScale(Vector3(100.0f, 50.0f, 50.0f));
	...
	terrain8Rend->SetShader("shader/litTextureVS.hlsl", "shader/litTexturePS.hlsl");
...

	{
		...
		terrain9Trans->SetPosition(Vector3(1550.0f, -20.0f, 0.0f));
		terrain9Trans->SetScale(Vector3(100.0f, 20.0f, 50.0f));
		...
		terrain9Rend->SetShader("shader/litTextureVS.hlsl", "shader/litTexturePS.hlsl");
		...
		terrain10Trans->SetPosition(Vector3(1650.0f, -10.0f, 0.0f));
		terrain10Trans->SetScale(Vector3(25.0f, 50.0f, 50.0f));
		...
		terrain10Rend->SetShader("shader/litTextureVS.hlsl", "shader/litTexturePS.hlsl");
	...
	terrain11Trans->SetPosition(Vector3(1850.0f, -35.0f, 0.0f));
	terrain11Trans->SetScale(Vector3(50.0f, 20.0f, 50.0f));
	...
	terrain11Rend->SetShader("shader/litTextureVS.hlsl", "shader/litTexturePS.hlsl");
	...
	terrain12Trans->SetPosition(Vector3(2050.0f, -10.0f, 0.0f));
	terrain12Trans->SetScale(Vector3(100.0f, 50.0f, 50.0f));
	...
	terrain12Rend->SetShader("shader/litTextureVS.hlsl", "shader/litTexturePS.hlsl");
...
void HighwayScene::TerrainsBack() {
	...
	terrainBack1Trans->SetPosition(Vector3(600.0f, -10.0f, 100.0f));
	terrainBack1Trans->SetScale(Vector3(100.0f, 50.0f, 50.0f));
	...
	terrainBack1Rend->SetShader("shader/litTextureVS.hlsl", "shader/litTexturePS.hlsl");
	terrainBack1Rend->SetColor(Vector4(1.0f, 0.0f, 0.0f, 1.0f));
	auto rigid1 = terrainBack1->AddComponent<RigidBodyComponent>();
	//	rigid2->SetLimitVelocity(Vector3(50.0f, 100.0f, 100.0f));
	rigid1->SetGravityFlag(false);
	...
	terrainBack2Trans->SetPosition(Vector3(1550.0f, -10.0f, 100.0f));
	terrainBack2Trans->SetScale(Vector3(100.0f, 50.0f, 50.0f));
	...
	terrainBack2Rend->SetShader("shader/litTextureVS.hlsl", "shader/litTexturePS.hlsl");
	terrainBack2Rend->SetColor(Vector4(1.0f, 0.0f, 0.0f, 1.0f));
