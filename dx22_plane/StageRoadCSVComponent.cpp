#include "StageRoadCSVComponent.h"
#include "CSV_Data.h"
...
StageRoadCSVComponent::StageRoadCSVComponent(GameObject& obj) : Component(obj) {
	m_sortNum = STAGE_ROAD_CSV; // ソート番号を設定
}

void StageRoadCSVComponent::Update() {

}

void StageRoadCSVComponent::RoadStageCSV(const std::string& fileName,GameObject& blockContainer) {
	...
	auto terrinMn = blockContainer.GetComponent<TerrainManagerComponent>();
